...
public interface EnterpriseMapper {
    ...
    String selectEnterprisePhoto(String username);
    ...
    List<EnterpriseDto> selectEnterpriseByPage(@Param("name") String name, @Param("status") StatusEnum status, @Param("data")Map<String,Object> data);

    Integer selectEnterpriseCount(@Param("name") String name, @Param("status") StatusEnum status);
}